      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse pt-3 ms-md-5" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto ">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="index.php?ctl=admin">Admin</a>
            </li>
            <?php endif;?>
          </ul>
          <div class="me-4 mb-2 ">
            <form class="d-flex">
              <div class="dropdown text-end me-3 ms-2 mt-1">
                <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle show" data-bs-toggle="dropdown" aria-expanded="true">
                  <img src="<?=$params['img_perfil']?>" alt="mdo" width="32" height="32" class="img-perfil rounded-circle">
                </a>
                <ul class="dropdown-menu text-small  mt-2" data-popper-placement="bottom-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 34px);">
                  <li><a class="dropdown-item" href="index.php?ctl=user">Profile</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="index.php?ctl=cierre_sesion">Sign out</a></li>
                </ul>
              </div>
            </form>
          </div>
          ...
          <div class="offcanvas offcanvas-end w-75" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body py-0">
              <ul class="navbar-nav justify-content-evenly flex-grow-1 text-center fs-5 fw-semibold h-100">
                ...
                <?php if($_SESSION['nivel']===2): ?>
                <li class="nav-item">
                  <a class="nav-link fs-3" href="index.php?ctl=admin">Admin</a>
                </li>
                <?php endif;?>
                <li class="nav-item m-0">
            ...
            <div class="offcanvas-footer d-flex justify-content-around py-4 text-white fw-semibold fs-5 text-center">
              <a class="nav-link link-light" href="index.php?ctl=user">Profile</a>
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-person-fill"
                viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
              </svg>
              <a class="nav-link link-light" href="index.php?ctl=cierre_sesion">Sign Out</a>
            </div>
